        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="row">
                        ...
                        <tbody>
                            @forelse ($users as $user)
                                ...
                                @php
                                    ...
                                    //     if ($user->role->role == "ROLE_ADMIN_GERAL") {
                                    //         dd('sim');
                                    //     }
                                    //     else {
                                    //         dd('não');
                                ...
                                @php if(($user->role()->count() > 0) && ($user->role->role == "ROLE_ADMIN_GERAL")): @endphp
                                    <tr>
                                        <td ></td>
                                        <td ></td>
                                        <td ></td>
                                ...
                                @php else: @endphp
                                    <tr>
                                        {{-- @php//f(($user->role()->count() > 0) && ($user->role->role == "ROLE_ADMIN_GERAL")):?> @endphp --}}
                                            {{-- <td ></td> --}}
                                        {{-- @php //else: @endphp --}}
                                            {{-- <td >{{$user->name}}</td> --}}
                                        {{-- @php // endif; @endphp --}}
                    ...
                    <table style="display: none" id="usertable" class="table table-striped " >
                        <thead>
                            <tr>
                                <th> Nome <br> ______ </th>
                                <th>Papél <br> ______</th>
